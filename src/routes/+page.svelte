...
<section class="flex flex-col items-start gap-5 text-left  transition duration-200 ease-in lg:max-w-[90%] ">
    <div class="flex flex-col gap-5">
        ...
        <h2 class="mt-12 mb-5 block text-[28.5px] md:text-5xl font-bold">Looking for a developer ?</h2>
        <div class="grid grid-cols-2 gap-4 ">
            <div>
                <h3>Working with diverse teams</h3>
                <span>Different backgrounds breed different perspectives, different perspectives breed solutions!</span>
            </div>
            <div>
                <h3>Working with diverse teams</h3>
                <span>Different backgrounds breed different perspectives, different perspectives breed solutions!</span>
